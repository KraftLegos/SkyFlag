...
public class OnPlayerDamage implements Listener {
    ...
    public void onPlayerDamage(EntityDamageByEntityEvent e) {
        ...
        if (e.getDamager() instanceof EnderDragon) {
            if (e.getEntity() instanceof Player) {
                ...
                Vector vec = new Vector(dir.getX() * 4.1D, dir.getY() * 4.1D, dir.getZ() * 4.1D);
    ...
    public  void onEntityDamage(EntityDamageEvent e) {
        if (e.getEntity() instanceof Player) {
            ...
            if (GameManager.getGame().isState(Game.GameState.LOBBY) || GameManager.getGame().isState(Game.GameState.STARTING)) {
